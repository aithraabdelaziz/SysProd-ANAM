...
def get_last_complete_decade(today=None):
    if today==None :
...
def plot_tiff_with_original_colormap(tif_path, shapefile_path, output_image="ndvi_colormap_mapAnomalie.png"):
    # Charger shapefile
...
if __name__ == "__main__":
    ...
    if go :
        ...
        if tif_path:
            ...
            crop_tif_keep_meta(tif_path, shapefile_path, output_tif="Anomalyndvi_original_tif.tif")
            ...
            tiff_to_png_with_annotations(
                tif_path="Anomalyndvi_original_tif.tif",
                png_path=png_name,
