...
now = datetime.now()
print(now.strftime("[%Y-%m-%d %H:%M:%S]")+f" INFO Calcul de l evapotranspiration pour la periode ",end=' ')
...
print(f"        INFO Plage de dates: {start_date} -> {end_date}")
...
try :
    ...
    print("Error : sum_et0 non insérée")
    pass
...
try :
    ...
    print("Error : mean_et0 non insérée")
    pass
quit()
